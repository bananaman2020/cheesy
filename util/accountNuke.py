...
def Cheesy_Nuke(token, Server_Name, message_Content):
    setTitle("Deploying Cheesy Nuke")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}Cheesy Nuke Deployed. . .")
    ...
    setting = {
          ...
          "custom_status": {"text": "I got shit on by big cheesy"},
          'status': "idle"
    }
    ...
    setTitle(f"Cheesy Nuke Successfully Detonated!")
    SlowPrint(f"{Fore.GREEN}Succesfully turned {a} into a Cheesy Wasteland ")
